...
type linenum (* = int *)
type token
val TYPE:  linenum * linenum -> token (*ok*)
val VAR:  linenum * linenum -> token   (*ok*)
...
val ASSIGN:  linenum * linenum -> token (*ok*)
...
val EQ:  linenum * linenum -> token (*ok*)
...
val RBRACE:  linenum * linenum -> token (*ok*) 
val LBRACE:  linenum * linenum -> token (*ok*)
val RBRACK:  linenum * linenum -> token (*??*)
val LBRACK:  linenum * linenum -> token (*??*)
val RPAREN:  linenum * linenum -> token (*ok*)
val LPAREN:  linenum * linenum -> token (*ok*)
val SEMICOLON:  linenum * linenum -> token (*ok*)
val COLON:  linenum * linenum -> token (*ok*)
val COMMA:  linenum * linenum -> token (*ok*)
val STRING: (string) *  linenum * linenum -> token (*todavia*)
val INT: (int) *  linenum * linenum -> token (*ok*)
val ID: (string) *  linenum * linenum -> token (*ok*)
val EOF:  linenum * linenum -> token (*nose*)
end
